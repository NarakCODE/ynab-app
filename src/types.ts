...
export type NavigationRootItem = NavigationRootItemWithHrefType | NavigationRootItemWithItemsType;
...
export type NavigationNestedItem = NavigationNestedItemWithHrefType | NavigationNestedItemWithItemsType;
