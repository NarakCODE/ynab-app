...
export function ButtonLoading({
	...
	let RenderedIcon;
	if (isLoading) {
		RenderedIcon = <LoaderCircle className={cn('me-2 size-4 animate-spin', loadingIconClassName)} aria-hidden />;
	} else if (Icon) {
		RenderedIcon = <Icon className={cn('me-2 size-4', iconClassName)} aria-hidden />;
	}
